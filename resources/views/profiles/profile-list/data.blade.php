            ...
            <form id="profile-form" action="{{ route('profiles.profile.update', $profile->id) }}" method="POST">
                ...
                <div class="row mb-2">
                    ...
                    <div class="form-group col-4">
                        ...
                        <input type="text" class="form-control" id="last-name" name="last_name" value="{{ old('last_name', $profile->last_name) }}"
                            required disabled>
                        @error('last_name')
                            <div class="text-danger small">{{ $message }}</div>
                        @enderror
                    ...
                    <div class="form-group col-3">
                        ...
                        <div class="d-flex justify-content-end align-items-end mt-4">
                            ...
                            <div class="me-2 d-inline-block">
                                <button type="submit" class="btn btn-success px-4"><i class="fa-solid fa-check"></i>
                                    Save
                                    Profile</button>
